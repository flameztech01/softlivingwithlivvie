...
import { FaRobot, FaGlobe, FaGraduationCap, FaShieldAlt, FaMoneyBillWave, FaHandsHelping } from 'react-icons/fa'
  ...
  const features = [
    {
      ...
      description: "Earn legit income using advanced AI tools for content creation"
    },
    {
      icon: <FaGlobe className="text-3xl" />,
      title: "Works Worldwide",
      description: "Accessible from anywhere, payments sent directly to your bank"
    },
    {
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <p className="text-xl text-gray-300">
            by <span className="text-[#D4AF37] font-semibold">Softliving with Livvie</span>
          </p>
        </div>
            ...
            <div className="bg-gradient-to-br from-gray-900 to-black border border-gray-800 rounded-2xl p-6 md:p-8 mb-8">
              ...
              <div className="space-y-6">
                <p className="text-xl leading-relaxed">
                  Earn legit income writing with AI — <span className="text-[#D4AF37] font-semibold">no betting, no referrals, no stress</span>.
                </p>
                
                <div className="bg-gray-900/50 p-6 rounded-xl border-l-4 border-[#D4AF37]">
                  <p className="text-lg md:text-xl">
                    <span className="text-[#D4AF37] font-bold">Works worldwide</span>, pays directly to your bank, and includes full mentorship.
                  </p>
                </div>
              ...
              <div className="mt-8 pt-8 border-t border-gray-800">
                <button className="bg-[#D4AF37] text-black font-bold px-8 py-4 rounded-lg hover:bg-[#B8860B] transition-all duration-300 transform hover:scale-105 text-lg w-full md:w-auto">
          ...
          <div className="lg:w-1/3">
            <div className="sticky top-8">
              ...
              <div className="mt-8 bg-gradient-to-r from-[#D4AF37] to-[#B8860B] p-6 rounded-xl text-center">
                <h4 className="text-xl font-bold text-black mb-2">Limited Time Offer</h4>
                <p className="text-black mb-4">Get started today and receive 1-on-1 coaching session</p>
        ...
        <div className="mt-16 text-center">
          ...
          <p className="text-xl italic text-gray-300 max-w-3xl mx-auto">
            "Thanks to Coach Olivia's AI course, I went from zero to earning $2,500 monthly writing with AI tools. Life-changing!"
          </p>
